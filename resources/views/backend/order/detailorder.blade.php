						...
						<div class="bootstrap-table">
							<div class="table-responsive">
								...
								<div class="alert alert-primary" role="alert" align='right'>
									<a onclick="return process()" href="/admin/order/paid/{{ $order->id }}" class="btn btn-success" href="#" role="button">Đã xử lý</a>
								</div>
							</div>
						</div>
...
@parent
    <script>
        function process(){
            return confirm("Đơn hàng sau khi xử lý sẽ được tính vào danh thu! ");
        }
    </script>
@endsection
