                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <select name="category" class="form-control">
                                                {{ GetCategory($categorys,0,"",$product->category_id) }}
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select  name="featured" class="form-control">
                                                <option @if($product->state==0) selected @endif value="0">Không</option>
                                                <option  @if($product->state==1) selected @endif  value="1">Có</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Trạng thái</label>
                                            <select  name="state" class="form-control">
                                                <option  @if($product->featured==1) selected @endif value="1">Còn hàng</option>
                                                <option @if($product->featured==0) selected @endif  value="0">Hết hàng</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
